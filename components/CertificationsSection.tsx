      ...
      <div className="max-w-[1600px] mx-auto px-6 sm:px-12 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto" style={{ fontFamily: 'Consolas, "Courier New", monospace' }}>
            Professional certifications that demonstrate expertise in modern technologies and best practices.
          </p>
        </div>
        ...
        <div className="text-center">
          <Link
            href="/certifications"
            className="group relative inline-flex items-center px-10 py-5 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 text-white font-bold rounded-2xl transition-all duration-500 transform hover:scale-110 hover:-translate-y-2 shadow-2xl hover:shadow-3xl overflow-hidden"
